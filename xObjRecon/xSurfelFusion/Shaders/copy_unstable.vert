...
void main()
{
    ...
    if((count > 8 || zCount > 4) && vColor.y == fragInd)
    {
        test = 0;
    }
	...
	if(isFrag == 1 && vPosition.w < 5 && vColor.y == fragInd)
	{
		test = 0;
	}
	...
	//if((vColor.w == -1 || (isFrag == 1 && vPosition.w < 10 && vColor.y == fragInd)))
	//int val = time - 1 - fragInd * 40;
	//if(vColor.w == -1 || (vPosition.w < val / 5 && vColor.y == fragInd))
	//if((isFrag == 1 && vPosition.w < 10 && vColor.y == fragInd))
    //{
        //test = 0;
    //}
	/*
    if((vColor.w == -1 || ((time - vColor.w) > 5 && vPosition.w < confThreshold && vColor.y == fragInd)))
    {
        test = 0;
    }
