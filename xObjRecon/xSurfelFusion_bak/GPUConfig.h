...
private:
		...
		so3StepBlocks(64)
	{
		...
		*/
		{
			icpStepThreads = icpStepMap["GeForce GTX 1060"].first;
			icpStepBlocks = icpStepMap["GeForce GTX 1060"].second;
		}
		...
		*/
		{
			rgbStepThreads = rgbStepMap["GeForce GTX 1060"].first;
			rgbStepBlocks = rgbStepMap["GeForce GTX 1060"].second;
		}
		...
		*/
		{
			rgbResThreads = rgbResMap["GeForce GTX 1060"].first;
			rgbResBlocks = rgbResMap["GeForce GTX 1060"].second;
		}
		...
		*/
		{
			so3StepThreads = so3StepMap["GeForce GTX 1060"].first;
			so3StepBlocks = so3StepMap["GeForce GTX 1060"].second;
		}
	}
